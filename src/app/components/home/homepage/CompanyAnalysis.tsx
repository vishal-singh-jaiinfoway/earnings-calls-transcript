...
const CompanyAnalysis = () => {
  return (
    <section className="bg-gradient-to-b from-[#fafaff] to-[#f3f4f9] flex flex-col items-center px-6 py-16">
      <div className="flex flex-col md:flex-row items-center justify-between max-w-7xl w-full relative gap-12">
        {/* Left Side */}
        <motion.div
        ...
        >
          ...
          <p className="text-gray-600 text-lg leading-relaxed">
            Skip the tedious reading and get straight to the insights. Our AI-driven platform delivers instant summaries, competitive analysis, and key trend highlights, helping you focus on smarter decision-making.
          </p>
...
<CheckSquare color="green"></CheckSquare>
              <div>
                <h3 className="font-semibold text-lg text-gray-800">Instant AI summaries</h3>
                <p className="text-gray-500">No more sifting through pages of transcripts.</p>
              </div>
            </div>
...
<TrendingUpDown></TrendingUpDown>
              <div>
                <h3 className="font-semibold text-lg text-gray-800">Compare Competitors</h3>
                <p className="text-gray-500">Gain an edge with side-by-side analysis.</p>
              </div>
            </div>
...
<BsLightbulbFill color="gold"></BsLightbulbFill> 
             <div>
                <h3 className="font-semibold text-lg text-gray-800">Spot Key Trends</h3>
                <p className="text-gray-500">Identify market movements in real time.</p>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="relative w-full max-w-md flex flex-col items-center">
            ...
            >
              <Image src={BGright} alt="Background Right" className="w-full opacity-70" />
            </motion.div>
            ...
            >
              <Image src={FinancialMetrics} alt="Financial Metrics" className="w-full rounded-xl" />
            </motion.div>
            ...
            >
              <Image src={MarketMetrics} alt="Market Metrics" className="w-full rounded-xl" />
            </motion.div>
