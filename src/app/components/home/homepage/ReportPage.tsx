  ...
  return (
    <section className="bg-gradient-to-br from-[#f9f9fb] to-[#eef1f5] py-16 px-6 lg:px-8 flex flex-col items-center">
      <div className="w-full flex flex-col md:flex-row items-start md:items-center justify-between relative">
        ...
        >
          <p className="text-lg font-medium text-purple-600 uppercase tracking-widest">Report</p>
          ...
          <p className="text-md lg:text-lg text-gray-500">
             AAPL |  GOOG |  TSLA |  MCD | 
             NVDA |AMZN |  MSFT |  JPM |  META 
          </p>
          <p className="text-gray-700 text-lg mt-4">
            Discover how AI-driven insights deliver measurable ROI. Forrester Consulting analyzed the Total Economic Impact
            of leveraging AI for insights and found a 141% ROI over three years.
          </p>
        </motion.div>
          ...
          {[
            {
              ...
              description: "Save hours with instant AI-generated summaries of earnings call transcripts.",
              bg: "bg-purple-100",
            },
            {
              icon:<Brain color="brown"></Brain>,
              title: "Real-Time Insights",
              description: "Enhance financial decision-making with real-time AI-driven analysis.",
              bg: "bg-yellow-100",
            },
            {
              icon:<CheckSquare color="green"></CheckSquare>,
              title: "Improved Accuracy",
              description: "Reduce manual research efforts and minimize errors with AI-powered insights.",
              bg: "bg-green-100",
            },
          ].map((item, index) => (
            <motion.div
