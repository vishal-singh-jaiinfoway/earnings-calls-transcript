...
const generateResponse = async (prompt, rawPrompt, chats, context, persona, foundationModel,
    ...
    try {
        ...
        const optimizedPrompt = await optimizePrompt(previousPrompts, previousPrompts.length ? rawPrompt : prompt, JSON.stringify(selectedCompanies), selectedQuarter, selectedYear, chats);
