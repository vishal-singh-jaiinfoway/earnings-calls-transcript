        ...
        <div className="flex flex-col px-6 py-6 space-y-6 bg-purple-50 min-h-screen">
            {
                ...
                </div> : <Card className="bg-white shadow-md border border-gray-200 rounded-xl max-w-[75vw] m-auto">
                    {/* <CardHeader>
                <CardTitle className="text-xl font-semibold text-[#2563eb] tracking-wide">
                    Transcript
                </CardTitle>
            </CardHeader> */}
                    <CardContent className="py-6">
                            {
                                ...
                                transcript?.transcript?.length ? <div className="prose ml-6 text-gray-700">
                                ...
                                </div> : <p>No Data Available<br></br>Select a Company to get started.</p>
